...
✅ **채팅**
- WebSocket + SpringSTOMP를 이용하여 실시간 채팅 메시지 처리
...
✅ **채팅번역기능**
- Microsoft Translator API를 이용하여 채팅에 대한 번역기능을 구현했습니다.
- 언어별 처리가 가능하며 현재 테스트 결과 번역기능은 잘 동작 하지만 번역의 퀄리티가 아쉬워 DeepL로 변경하여 이용하려 생각중입니다.
...
이 프로젝트는 개발 중이며, WebSocket 기반의 채팅기능을 완성했습니다. 
